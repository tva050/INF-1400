...
class Game:
    def __init__(self):
        ...
        # Spaceships
        self.player1_spaceship = Spaceships(Config.PLAYER1_IMG, Config.START_POSITION_PLAYER1, Config.PLAYER_VELOCITY)
        self.player2_spaceship = Spaceships(Config.PLAYER2_IMG, Config.START_POSITION_PLAYER2, Config.PLAYER_VELOCITY)
        ...
        if spaceship == self.player1_spaceship:
            if keys[pygame.K_LCTRL]:
                if self.player1_spaceship.shoot_cooldown == 0:
                    ...
                    spaceship.beams.add(LaserBeam(Config.PLAYER1_BEAM, (spaceship.rect.centerx, spaceship.rect.top)))
            ...
            if keys[pygame.K_RCTRL]:
                if self.player2_spaceship.shoot_cooldown == 0:
                    ...
                    spaceship.beams.add(LaserBeam(Config.PLAYER2_BEAM, (spaceship.rect.centerx, spaceship.rect.top)))
